...
if(isset($_POST['login_submitted']))
{
    ...
    $ins = ("INSERT INTO transactions(transaction_id, transaction_date, transaction_type,transaction_amount, account_id_fk, atm_id_fk) VALUES ('', 'current_timestamp()', 'deposit','$trans_amount', '$array[0]','1')");
...
echo '<br><br>';
echo 'Deposit amount:<br> <input type = "text" name = "transaction_amount"> <br><br/>';
